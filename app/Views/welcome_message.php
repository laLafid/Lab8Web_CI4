...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="<?=base_url('artikel'); ?>">Artikel</a></li>
            <li class="menu-item hidden"><a href="<?= base_url('about'); ?>">About</a></li>
            <li class="menu-item hidden"><a href="<?=base_url('contact'); ?>">Kontak</a></li>
        </ul>
    </div>
